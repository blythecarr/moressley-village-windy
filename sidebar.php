            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open"> <a href="dashboard.php" class="nav-link active">
                        ...
                        <li class="nav-item"> <a href="data_desa.php" class="nav-link"> <i class="nav-icon bi bi-circle text-warning"></i>
                                <p>Data Desa</p>
                            </a> </li>
